...
/**
 * Esta clase genera las instancias de los 5 hilos Filósofos {@link Filosofos} ,
 ...
 * Además si se selecciona crear un Log en el área de texto de la interface gráfica {@link VentanaPrincipal}
...
public class ControladorPrincipal {
    ...
    /**
     * Se generan las instancias de 5 de {@link Filosofos}, 5 {@link Tenedor}, 
     * una de {@link Portero_del_Comedor}, una de {@link Log} y una de {@link ControladorExcepciones},
    ...
    public ControladorPrincipal(ControladoresGenerales clase10Control) { 
        ...
        for(int i=0; i<filosofo.length; i++){
            ...
            */
            ...
            filosofo[i] = new Filosofos(i, tenedor[i], tenedor[(i+1)%5], comensal, jLabel_F[i], jLabel_T[i], jLabel_T[(i+1)%5], log, jTextField_C[i]);
        }
