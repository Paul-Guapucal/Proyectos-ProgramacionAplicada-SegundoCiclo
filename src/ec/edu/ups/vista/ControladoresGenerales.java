...
public class ControladoresGenerales {
     ...
     */
    public ControladoresGenerales(JLabel jLabel_Filo01, JLabel jLabel_Filo02, JLabel jLabel_Filo03, JLabel jLabel_Filo04, JLabel jLabel_Filo05, 
        ...
        /*for (int i : filoCount){
            ControladoresGenerales.filoCount[i] = 0;
        }*/
    ...
    public static void setjTextArea_Info(String mensaje) {
        ControladoresGenerales.jTextArea_Log.append(mensaje + "\n");
        ControladoresGenerales.jTextArea_Log.setCaretPosition(ControladoresGenerales.jTextArea_Log.getDocument().getLength()); 
    }
