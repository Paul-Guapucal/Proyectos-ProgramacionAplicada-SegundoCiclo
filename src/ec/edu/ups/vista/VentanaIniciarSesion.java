...
public final class VentanaIniciarSesion extends javax.swing.JInternalFrame {
     ...
     */
    public VentanaIniciarSesion(VentanaPrincipal ventanaPrincipal, ControladorRector controladorUsuario) throws IOException {
        initComponents();
    ...
    public void generarAdmin() {
        ...
        Profesor docente = new Profesor("1303753618", "DIEGO", "QUISI", 48, "EL VECINO", "MASTER EN SISTEMAS", "MASTERADO");
